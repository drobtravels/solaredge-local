...
_MAINTENANCE_DIAGNOSTICS_INVERTERS_UNIT_ISOLATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='rIso', full_name='Maintenance.Diagnostics.Inverters.Unit.Isolation.rIso', index=0,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='faultLocation', full_name='Maintenance.Diagnostics.Inverters.Unit.Isolation.faultLocation', index=1,
      number=3, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
